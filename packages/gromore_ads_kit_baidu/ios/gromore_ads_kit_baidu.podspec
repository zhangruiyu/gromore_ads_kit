Pod::Spec.new do |s|
  s.name = 'gromore_ads_kit_baidu'
  s.version = '1.0.0'
  s.summary = 'GroMore 百度广告可选适配包'
  s.description = '为 gromore_ads_kit 提供百度广告原生 SDK 和 GroMore Adapter。'
  ...
  s.vendored_frameworks = 'Vendor/CSJMBaiduAdapter/CSJMBaiduAdapter.xcframework'
  s.platform = :ios, '13.0'
