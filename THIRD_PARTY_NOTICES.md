...
`2.0.0` 起这些二进制位于对应 ADN 扩展包，详细清单见各扩展包内的
...
- 原生 SDK 文件：`packages/gromore_ads_kit_ks/android/maven/com/kuaishou/local/kssdk-ad/5.3.20.1/kssdk-ad-5.3.20.1.aar`
...
- 版本：`1.2.0`
- 文件：`packages/gromore_ads_kit_gdt/ohos/libs/GDTUnionSDK-default-release.har`
